...
type BlogPost = {
  ...
  /** ใหม่: ใช้ขยับรูปภายในกรอบ (คง object-cover ไว้) */
  objectPosition?: string; // e.g. '50% 20%', 'center top'
};
...
const defaultPosts: BlogPost[] = [
  {
    ...
    image: "/car1.jpg",
    link: "/carinsure1",
    // ขยับลงเล็กน้อยให้เห็นตัวเลข/ตัวอักษรด้านบนเต็มขึ้น
      ...
      <div className="max-w-(--breakpoint-xl) mx-auto py-16 px-6 xl:px-0">
        ...
        <div className="mt-4 grid sm:grid-cols-2 lg:grid-cols-3 gap-10">
          {posts.map((post) => {
            ...
            // ถ้าไม่กำหนด objectPosition สำหรับโพสต์นั้นๆ จะใช้กลางภาพปกติ
            const objPos = post.objectPosition ?? "50% 50%";
